...
import HomeHeaderImage from '../assets//header-homepage.jpg';
...
function Header() {
  ...
  // Trouver l'état ou la province correspondant dans les données JSON
  ...
  return (
    <header className='header'>
      ...
      {/* Afficher l'image spécifique pour la page d'accueil */}
      {isHomePage && (
        <div>
          <img src={HomeHeaderImage} alt="home header" className='header__logo' />
        </div>
      )}
      ...
      <div className='header__navbar-container'>
        <ul className='header__navbar'>
          <Link to="/" style={{ textDecoration: 'none' }}>
            <li className={`header__navbar__txt ${isHomePage ? 'active' : ''}`}>Home</li>
          </Link>
